...
screen.title("ONLINE COLLEGE COUNSELLING PORTAL - 2020")
...
cv_img = cv2.cvtColor(cv2.imread("img.png"), cv2.COLOR_BGR2RGB)
...
register = Button(text = "Submit For Counselling", width = "40", height = "2", command= save_info, bg = "blue",fg='yellow')
